...
class ui(tk.Tk):
    def __init__(self):
        ...
        self.title('WAQT')
        self.iconbitmap("E:\GitHub\Clock\icon.ico")
...
im=PhotoImage(file="E:\GitHub\Clock\\timericon.png")
im2=PhotoImage(file="E:\GitHub\Clock\\timeicon.png")
...
def timer2(e):
    ...
    inp.pack(side=LEFT,pady=9)
    root.bind("<Return>",cursor)

 
clock=Button(option,image=im2,width=64,height=64,background="#616161",border=0,activebackground="#616161")
clock.bind("<Button-1>",time1)
clock.pack(side=TOP,)

timer=Button(option,image=im,width=64,height=74,border=0,background="#616161",activebackground="#616161")
